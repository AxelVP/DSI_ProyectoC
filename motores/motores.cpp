...
#define SERVO_MAX 1750
#define SERVO_MIN 1000
#define SERVO_MED 1375
        ...
        char** argv)
{
  ...
  int i=0;
    ...
    while(true){
        std::cout << "v_1: " << pid_.v_1() << std::endl;
        std::cout << "v_2: " << pid_.v_2() << std::endl;
        std::cout << "v_3: " << pid_.v_3() << std::endl;
        std::cout << "v_4: " << pid_.v_4() << std::endl;
        std::cout << std::endl; 

        pwm->set_duty_cycle(PWM_OUTPUT_0, pid_.v_1());                       //pid_.v_1()
        pwm->set_duty_cycle(PWM_OUTPUT_1, pid_.v_2());                       //pid_.v_2()
        pwm->set_duty_cycle(PWM_OUTPUT_2, pid_.v_3());                       //pid_.v_3()
        pwm->set_duty_cycle(PWM_OUTPUT_3, pid_.v_4());                      //pid_.v_4()
        usleep(20000); 
        /*pwm->set_duty_cycle(PWM_OUTPUT_0, SERVO_MIN);
        pwm->set_duty_cycle(PWM_OUTPUT_1, SERVO_MIN);
        pwm->set_duty_cycle(PWM_OUTPUT_2, SERVO_MIN);
